...
public class Homework3 {
    ...
    public static void main(String[] args) {
         ...
         */
        printArray1("7. Find min & max in array\t", array3);
        System.out.println("7. Minimum: " + findMin(array3));
        System.out.println("7. Maximum: " + findMax(array3));
        ...
        System.out.print("8. Is the " + Arrays.toString(balance) + " balanced? ");
